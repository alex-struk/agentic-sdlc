...
p.cards([
    {"title": "Constitution", "acc": "gold",
     "badge": ("made at onboarding · owned by the team", "warn"),
    ...
    {"title": "Intent", "acc": "navy",
     "badge": ("made by intent stage · judged at G0", "tint"),
    ...
    {"title": "Spec", "acc": "navy",
     "badge": ("made by archaeology or intent · judged at G1", "tint"),
    ...
    {"title": "Contract", "acc": "navy",
     "badge": ("made by archaeology and design · judged at G1 and G-DESIGN", "tint"),
...
p.cards([
    {"title": "Tests and adapters", "acc": "navy",
     "badge": ("made by derive-tests and bind-adapter · human approval", "tint"),
    ...
    {"title": "Design spec and catalogue", "acc": "navy",
     "badge": ("made by design stage · judged at G-DESIGN", "tint"),
    ...
    {"title": "Plan, tasks, evidence", "acc": "navy",
     "badge": ("made by plan and build · judged at G2 and G3", "tint"),
    ...
    {"title": "State site", "acc": "green",
     "badge": ("generated by status · no gate", "ok"),
